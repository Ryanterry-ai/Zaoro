...
const wsDir = path.join(WS_BASE, "ws-1782888220057-nditnh");
...
const config = JSON.parse(fs.readFileSync(path.join(process.cwd(), ".build-config-ws-1782888220057-nditnh.json"), 'utf-8'));
const payload = JSON.parse(fs.readFileSync(path.join(process.cwd(), ".build-prompt-ws-1782888220057-nditnh.json"), 'utf-8'));
