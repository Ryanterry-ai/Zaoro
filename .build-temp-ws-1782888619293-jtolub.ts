...
const wsDir = path.join(WS_BASE, "ws-1782888619293-jtolub");
...
const config = JSON.parse(fs.readFileSync(path.join(process.cwd(), ".build-config-ws-1782888619293-jtolub.json"), 'utf-8'));
const payload = JSON.parse(fs.readFileSync(path.join(process.cwd(), ".build-prompt-ws-1782888619293-jtolub.json"), 'utf-8'));
