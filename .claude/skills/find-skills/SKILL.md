...
Check the [skills.sh leaderboard](https://skills.sh/) to see if a well-known skill already exists.
...
In the build pipeline, invoke find-skills BEFORE BRE v2 runs to identify which domain skills are relevant for a given build. This replaces hardcoded skill routing with dynamic skill discovery.
