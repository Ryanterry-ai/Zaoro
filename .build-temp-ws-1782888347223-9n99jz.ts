...
const wsDir = path.join(WS_BASE, "ws-1782888347223-9n99jz");
...
const config = JSON.parse(fs.readFileSync(path.join(process.cwd(), ".build-config-ws-1782888347223-9n99jz.json"), 'utf-8'));
const payload = JSON.parse(fs.readFileSync(path.join(process.cwd(), ".build-prompt-ws-1782888347223-9n99jz.json"), 'utf-8'));
