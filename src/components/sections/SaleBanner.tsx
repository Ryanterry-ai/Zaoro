    ...
    <section className="bg-[#F8F6F3] py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <p className="text-xs tracking-widest uppercase text-[#C8A882] mb-3">Season sale</p>
            <h2 className="font-serif text-5xl md:text-6xl font-light text-[#0A0A0A] mb-6 leading-tight">
            ...
            <Link href="/products/new-arrivals" className="btn-primary inline-block">
              Shop New Arrivals
            </Link>
          </div>
