    ...
    <section className="bg-[#F8F6F3] py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <p className="text-xs tracking-widest uppercase text-[#6B6B6B] mb-3">Modern Details</p>
            <h2 className="font-serif text-4xl md:text-5xl font-light text-[#0A0A0A] mb-6 leading-tight">
