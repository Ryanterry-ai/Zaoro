/**
 * Experience Intelligence - Supplementary Types
 *
 * These are additional types used by the experience engines
 * (scroll-narrative, scene-planner, hover-intelligence, motion-language).
 * The canonical types are in ./types.js.
 */
